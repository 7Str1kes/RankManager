 ...
 */
public class DemoteCmd extends Command {

    public DemoteCmd(CommandManager manager) {
        super(manager, "demote", "rankmanager.demote");
    }
    ...
    public List<String> usage() {
        return getLanguageFile().getStringList("DEMOTE_CMD.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        rankManager.demotePlayer(player, target);
    }
}